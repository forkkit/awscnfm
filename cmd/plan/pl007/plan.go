...
var Plan = []plan.Step{
	{
		Action:  "create/cluster/customsubnet",
		Backoff: plan.NewBackoff(10*time.Second, 2*time.Second),
	},
	{
		Action:  "create/nodepool/customsubnet",
		Backoff: plan.NewBackoff(10*time.Second, 2*time.Second),
	},
	{
	...
	{
		Action:  "verify/cluster/customsubnet",
		Backoff: plan.NewBackoff(2*time.Minute, 15*time.Second),
	},
	{
